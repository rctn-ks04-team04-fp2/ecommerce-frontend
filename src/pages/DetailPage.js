...
const DetailPage = () => {
  ...
  return (
    ...
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src={item.image}></img>
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div class="flex mb-4">
          ...
          {[...Array(Math.floor(item.rating.rate))].map((object, i) => (
            ...
            <span class="text-gray-600 ml-3">{item.rating.rate} Review(s)</span>
          </span>
        </div>
        ...
        <div class="flex">
          ...
          <button class="ml-auto text-white bg-blue-500 border-0 py-2 px-6 hover:bg-blue-600 rounded">Add to cart</button>
        </div>
      </div>
    </div>
  </div>
